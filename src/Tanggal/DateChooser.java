...
public final class DateChooser extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdForward = new Tanggal.Button();
        MY = new javax.swing.JLayeredPane();
        cmdMonth = new Tanggal.Button();
        lb = new javax.swing.JLabel();
        cmdYear = new Tanggal.Button();
        cmdPrevious = new Tanggal.Button();
        slide = new Tanggal.Slider();
        ...
        cmdForward.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Tanggal/forward.png"))); // NOI18N
        ...
        cmdPrevious.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Tanggal/previous.png"))); // NOI18N
    ...
    private Tanggal.Button cmdForward;
    private Tanggal.Button cmdMonth;
    private Tanggal.Button cmdPrevious;
    private Tanggal.Button cmdYear;
    private javax.swing.JPanel header;
    private javax.swing.JLabel lb;
    private javax.swing.JPopupMenu popup;
    private Tanggal.Slider slide;
