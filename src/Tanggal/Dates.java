...
public final class Dates extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        cmdMo = new Tanggal.Button();
        cmdTu = new Tanggal.Button();
        cmdWe = new Tanggal.Button();
        cmdTh = new Tanggal.Button();
        cmdFr = new Tanggal.Button();
        cmdSa = new Tanggal.Button();
        cmdSu = new Tanggal.Button();
        cmd1 = new Tanggal.Button();
        cmd2 = new Tanggal.Button();
        cmd3 = new Tanggal.Button();
        cmd4 = new Tanggal.Button();
        cmd5 = new Tanggal.Button();
        cmd6 = new Tanggal.Button();
        cmd7 = new Tanggal.Button();
        cmd8 = new Tanggal.Button();
        cmd9 = new Tanggal.Button();
        cmd10 = new Tanggal.Button();
        cmd11 = new Tanggal.Button();
        cmd12 = new Tanggal.Button();
        cmd13 = new Tanggal.Button();
        cmd14 = new Tanggal.Button();
        cmd15 = new Tanggal.Button();
        cmd16 = new Tanggal.Button();
        cmd17 = new Tanggal.Button();
        cmd18 = new Tanggal.Button();
        cmd19 = new Tanggal.Button();
        cmd20 = new Tanggal.Button();
        cmd21 = new Tanggal.Button();
        cmd22 = new Tanggal.Button();
        cmd23 = new Tanggal.Button();
        cmd24 = new Tanggal.Button();
        cmd25 = new Tanggal.Button();
        cmd26 = new Tanggal.Button();
        cmd27 = new Tanggal.Button();
        cmd28 = new Tanggal.Button();
        cmd29 = new Tanggal.Button();
        cmd30 = new Tanggal.Button();
        cmd31 = new Tanggal.Button();
        cmd32 = new Tanggal.Button();
        cmd33 = new Tanggal.Button();
        cmd34 = new Tanggal.Button();
        cmd35 = new Tanggal.Button();
        cmd36 = new Tanggal.Button();
        cmd37 = new Tanggal.Button();
        cmd38 = new Tanggal.Button();
        cmd39 = new Tanggal.Button();
        cmd40 = new Tanggal.Button();
        cmd41 = new Tanggal.Button();
        cmd42 = new Tanggal.Button();
    ...
    private Tanggal.Button cmd1;
    private Tanggal.Button cmd10;
    private Tanggal.Button cmd11;
    private Tanggal.Button cmd12;
    private Tanggal.Button cmd13;
    private Tanggal.Button cmd14;
    private Tanggal.Button cmd15;
    private Tanggal.Button cmd16;
    private Tanggal.Button cmd17;
    private Tanggal.Button cmd18;
    private Tanggal.Button cmd19;
    private Tanggal.Button cmd2;
    private Tanggal.Button cmd20;
    private Tanggal.Button cmd21;
    private Tanggal.Button cmd22;
    private Tanggal.Button cmd23;
    private Tanggal.Button cmd24;
    private Tanggal.Button cmd25;
    private Tanggal.Button cmd26;
    private Tanggal.Button cmd27;
    private Tanggal.Button cmd28;
    private Tanggal.Button cmd29;
    private Tanggal.Button cmd3;
    private Tanggal.Button cmd30;
    private Tanggal.Button cmd31;
    private Tanggal.Button cmd32;
    private Tanggal.Button cmd33;
    private Tanggal.Button cmd34;
    private Tanggal.Button cmd35;
    private Tanggal.Button cmd36;
    private Tanggal.Button cmd37;
    private Tanggal.Button cmd38;
    private Tanggal.Button cmd39;
    private Tanggal.Button cmd4;
    private Tanggal.Button cmd40;
    private Tanggal.Button cmd41;
    private Tanggal.Button cmd42;
    private Tanggal.Button cmd5;
    private Tanggal.Button cmd6;
    private Tanggal.Button cmd7;
    private Tanggal.Button cmd8;
    private Tanggal.Button cmd9;
    private Tanggal.Button cmdFr;
    private Tanggal.Button cmdMo;
    private Tanggal.Button cmdSa;
    private Tanggal.Button cmdSu;
    private Tanggal.Button cmdTh;
    private Tanggal.Button cmdTu;
    private Tanggal.Button cmdWe;
