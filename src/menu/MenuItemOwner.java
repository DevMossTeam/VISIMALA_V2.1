...
public class MenuItemOwner extends JButton {
    ...
    public MenuItemOwner(String name, int index, boolean subMenuAble) {
        super(name);
        this.index = index;
        this.subMenuAble = subMenuAble;
    ...
    public void initSubMenu(int subMenuIndex, int length) {
        ...
        setBackground(new Color(53, 153, 134)); // background sub menu
        setOpaque(true);          
...
protected void paintComponent(Graphics grphcs) {
  super.paintComponent(grphcs);
        ...
        int shiftRight = 10; // Adjust this value as needed kiri garis
...
//                g2.drawLine(18, getHeight() / 2, 36, getHeight() / 2);
//            } else if (subMenuIndex == length - 1) {
//                //  Last Index
//                g2.drawImage(shadow, -shadowSize, getHeight() - 6, null);
...
//            p.lineTo(arrowWidth / 2, (1f - animate) * arrowHeight);
//            p.lineTo(arrowWidth, arrowHeight * animate);
//            g2.translate(getWidth() - arrowWidth - 20, (getHeight() - arrowHeight) / 4);
//            g2.setRenderingHint(RenderingHints.KEY_STROKE_CONTROL, RenderingHints.VALUE_STROKE_PURE);
//            g2.draw(p);
//        }
//        g2.dispose();
