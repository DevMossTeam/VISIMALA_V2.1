...
public class pilihTahun extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(pdff, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 150, 70, -1));
        ...
        getContentPane().add(clears, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 150, -1, -1));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/laporanKeuangan/Desain tanpa judul (40)_1.png"))); // NOI18N
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/laporanKeuangan/Desain tanpa judul (50).png"))); // NOI18N
    ...
    if (tabels != null) {
        ...
        try {
            ...
            doc.add(new Paragraph("Bulan: " + selectedMonth)); 
            ...
            for (Map.Entry<String, List<Object[]>> entry : groupedData.entrySet()) {
                ...
                tbl.addCell(createCell(calculateTotal(data, 1), 12, java.awt.Font.BOLD)); // Kolom laba
                tbl.addCell(createCell(calculateTotal(data, 2), 12, java.awt.Font.BOLD)); // Kolom pemasukan
                tbl.addCell(createCell(calculateTotal(data, 3), 12, java.awt.Font.BOLD)); // Kolom pengeluaran
